...
import { companiesByRegionQuery } from '../../queries/wheel';
...
export const ViewTwoGraphQL = (props) => {
  const wheelData = memoizeWheelData(props.allCompanies);
  ...
  const locationData = props.allRegions
    ? props.allRegions.sort((a, b) => {
