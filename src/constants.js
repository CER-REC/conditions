...
export const pdfLink = (lang === 'en')
  ? 'https://apps2.cer-rec.gc.ca/conditions/data/conditions-data-methodology.pdf'
  : 'https://apps2.cer-rec.gc.ca/conditions-projet/donnees/conditions-donnees-methodologie.pdf';
