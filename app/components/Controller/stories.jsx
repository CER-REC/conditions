...
storiesForComponent('Components|Controller', module, ReadMe)
  ...
  .add('withCircle', () => (
    <Controller x={number('x position(px)', 50, options)} ystart={number('y start position(px)', 20, heightOptions)} yend={number('y end position(px)', 40, heightOptions)} radius={number('radius(px)', 40, heightOptions)} />
  ))
  .add('withoutCircle', () => (
