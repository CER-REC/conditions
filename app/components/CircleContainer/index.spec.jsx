...
describe('Component|CircleContainer', () => {
  ...
  describe('Component renders with passed props', () => {
    it('should render the "CircleContainer" class and an extra class through the "elevated" prop', () => {
    ...
    it('should render the "CircleContainer" class and an extra class through the "disabled" prop', () => {
